...
function HomeCTA(){return <section className="cta-section section-shell"><div className="cta-panel"><div><Eyebrow>YOUR NEXT CHAPTER</Eyebrow><h2>Ready for a learning practice<br/>that feels like <em>yours?</em></h2><p>Build a space for your sources, questions, goals, and the next thing you want to understand.</p></div><div className="cta-orb">n</div><Link to="/auth" className="button button-light">Create your space <Arrow/></Link></div></section>;}
